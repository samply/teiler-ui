...
export class TeilerWelcomeComponent implements OnInit {
  ...
  teilerProject: string| undefined = undefined;
  teilerAdmin: TeilerAdmin = new TeilerAdmin();
  //TODO
  welcomeTitle: string = "Welcome to your " + this.teilerProject + "Bridgehead";
  ...
  constructor(environmentService: EnvironmentService) {
    environmentService.getEnvironmentSubscriber().subscribe(environment => {this.teilerProject = environment.teilerProject})
  }
